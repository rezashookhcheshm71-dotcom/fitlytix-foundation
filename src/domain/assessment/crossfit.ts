...
const sections: AssessmentSection[] = [
  { id: "crossfit.foundation", title: "سطح و اسکیلینگ", description: "تا تمرین از همان روز اول درست مقیاس شود", icon: "Flame", blockToken: "warmup", fields: [
    field({ id: "crossfit.history.duration", label: "چقدر سابقه CrossFit داری؟", type: "select", options: options("تازه شروع می‌کنم", "کمتر از ۶ ماه", "۶ ماه تا ۲ سال", "۲ تا ۴ سال", "بیشتر از ۴ سال"), required: true, purpose: "level" }),
    field({ id: "crossfit.schedule.sessions", label: "هفته‌ای چند جلسه CrossFit می‌ری؟", type: "scale", min: 1, max: 7, required: true, purpose: "load" }),
    field({ id: "crossfit.level.skill", label: "بیشتر تمرین‌ها را در چه سطحی انجام می‌دی؟", type: "select", options: options("Foundations · حرکت‌ها را یاد می‌گیرم", "Scaled · با نسخه ساده‌تر", "ترکیبی از Scaled و Rx", "Rx · بیشتر تمرین‌ها کامل", "مسابقه‌ای"), required: true, purpose: "scaling", wide: true }),
  ...
  { id: "crossfit.strength", title: "قدرت پایه", description: "رکوردها فقط وقتی به برنامه کمک می‌کنند که واقعاً تست شده باشند", icon: "Dumbbell", blockToken: "strength", fields: [
    ...
    field({ id: "crossfit.strength.front_squat_1rm", label: "Front Squat 1RM", type: "load", unit: "kg", depth: "intermediatePlus", allowUnknown: true, purpose: "load" }),
    field({ id: "crossfit.strength.deadlift_1rm", label: "Deadlift 1RM", type: "load", unit: "kg", allowUnknown: true, purpose: "load" }),
    field({ id: "crossfit.strength.strict_press_1rm", label: "Strict Press 1RM", type: "load", unit: "kg", depth: "intermediatePlus", allowUnknown: true, purpose: "load" }),
  ...
  { id: "crossfit.engine", title: "Engine و pacing", description: "برای انتخاب شدت و طول متکان‌ها", icon: "Wind", blockToken: "engine", fields: [
    ...
    field({ id: "crossfit.engine.bike_10min", label: "Bike در ۱۰ دقیقه", type: "number", unit: "cal", depth: "advancedPlus", allowUnknown: true, purpose: "level" }),
  ...
  { id: "crossfit.wod", title: "WOD و بنچمارک‌ها", description: "این بخش برای ورزشکار باتجربه است و اجباری نیست", icon: "Flame", blockToken: "wod", fields: [
    field({ id: "crossfit.benchmark.fran", label: "Fran", type: "time", unit: "دقیقه:ثانیه", depth: "intermediatePlus", allowUnknown: true, purpose: "level" }),
    field({ id: "crossfit.benchmark.grace", label: "Grace", type: "time", unit: "دقیقه:ثانیه", depth: "intermediatePlus", allowUnknown: true, purpose: "level" }),
    field({ id: "crossfit.benchmark.cindy", label: "Cindy", type: "number", unit: "راند", depth: "intermediatePlus", allowUnknown: true, purpose: "level" }),
    field({ id: "crossfit.benchmark.murph", label: "Murph", type: "time", unit: "دقیقه:ثانیه", depth: "advancedPlus", allowUnknown: true, purpose: "level" }),
  ]},
  { id: "crossfit.skill", title: "مهارت‌های ژیمناستیک", description: "مهارت‌هایی که الان با کنترل انجام می‌دی", icon: "Sparkles", blockToken: "skill", fields: [
    field({ id: "crossfit.skill.gymnastics", label: "کدام مهارت‌ها را داری؟", type: "multiselect", options: options("Pull-up", "Chest-to-Bar", "Toes-to-Bar", "Double Under", "HSPU", "Pistol"), purpose: "level", wide: true }),
  ...
  { id: "crossfit.weightlifting", title: "وزنه‌برداری", description: "رکوردهای تست‌شده برای تعیین درصدها", icon: "Weight", blockToken: "weightlifting", fields: [
    ...
    field({ id: "crossfit.weightlifting.clean_1rm", label: "Clean 1RM", type: "load", unit: "kg", depth: "intermediatePlus", allowUnknown: true, purpose: "load" }),
  ...
  { id: "crossfit.recovery", title: "بعد از تمرین", description: "برای تنظیم فاصله جلسات و cooldown", icon: "Moon", blockToken: "cooldown", fields: [
    ...
    field({ id: "crossfit.limiters.training", label: "الان چه چیزی بیشتر تمرینت را محدود می‌کنه؟", type: "multiselect", options: options("وقت", "ریکاوری", "موبیلیتی", "تکنیک", "قدرت", "نفس", "مهارت", "درد یا آسیب"), purpose: "programming", wide: true }),
  ]},
];
