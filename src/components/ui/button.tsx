  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-ember text-primary-foreground shadow-glow hover:shadow-glow-lg hover:brightness-110",
        glass:
          "bg-card/60 text-foreground border border-border/70 backdrop-blur-md hover:bg-card hover:border-primary/40",
      },
      size: {
